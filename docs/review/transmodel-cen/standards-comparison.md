...
![](../../assets/images/transmodel-cen/S_to_T.png)
...
![](../../assets/images/transmodel-cen/d43822a2-51f0-468f-b766-9baf49682c8d.png)*Use of conceptual models for the comparison of different levels of abstraction*
...
In brief, there are the following different levels of comparison: 
  ...
  -   -   - A mapping (comparison) between two models. It may be carried out by using a variety of techniques, with an increasing level of precision.
          ...
          - A full specification of every aspect (attributes, data types, lexical scope, etc) sufficient to develop a conversion tool ([example](../../assets/files/2024-June_DATA4PT_GTFS-NeTEx-Mapping_vf.pdf) of the GTFS to NeTEx mapping)
