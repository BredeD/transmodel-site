...
The diagram below is the planned target architecture for static and real-time public transport data. ![Planned target architecture in Australia](../../assets/images/wiki/Australia_architecture.jpg "Planned target architecture in Australia")
