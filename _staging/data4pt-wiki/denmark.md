...
![Map of Denmark, with a focus on Greater Copenhagen](../../docs/assets/images/wiki/Map_DK.png "Map of Denmark, with a focus on Greater Copenhagen")
...
The system will expose NeTEx as well as SIRI data. NeTEx will be exposed using the Nordic-based profile as well as EPIP. ![TMS solution](../../docs/assets/images/wiki/Data_providers.png "TMS solution")
