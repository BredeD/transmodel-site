---
original_title: "Standards harmonisation"
source: wordpress
source_url: https://transmodel-cen.eu/index.php/standards-harmonisation/
slug: standards-harmonisation
parent_id: 0
published: 2024-03-01 15:49:15
status: raw
---
...
Examples of the integration into Transmodel of new requirements originating from other standards is presented in the paper “[Transmodel Standards Harmonisation](../../docs/assets/files/StandardsHarmonisation-2019-njsk-v1.0-1.pdf)”. 

The process  of harmonisation is in most cases preceded by a comparison (mapping) described in [Comparison](https://mockuptm.itforpt.be/index.php/standards-comparison/) or [Conformity](https://mockuptm.itforpt.be/index.php/conformity/) check. 
