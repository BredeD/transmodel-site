...
source: wordpress
source_url: https://transmodel-cen.eu/index.php/governance/
slug: governance
parent_id: 0
published: 2024-02-23 14:58:11
status: raw
---
...
The European Committee for Standardization is one of three European Standardization Organizations (together with [CENELEC](https://www.cencenelec.eu/) and ETSI) that have been officially recognized by the European Union and by the European Free Trade Association (EFTA) as being responsible for developing and defining voluntary standards at European level (more [here](https://www.cencenelec.eu/)).

The work organisation in CEN is summarised in this figure: Technical Committees (TCs) split into WGs (Working Groups)  

![Figure 1: Work organisation of CEN](../../docs/assets/images/transmodel-cen/Screenshot-from-2024-04-25-12-02-23-300x260.png)

Transmodel is developed by TC 278 WG3 (Public Transport) as shown in the following picture:

![Figure 2: The Working Group (WG) 3 on Public Transport as part of overall activity of CEN TC 278 (Technical Committee).](../../docs/assets/images/transmodel-cen/governance_fig.1_v20240906-1024x576.jpg)

TC 278 WG3 splits on its turn into Sub-Groups (SGs) as shown in the picture below:  

![Figure 3: The structure of the working group CEN/TC278/WG3.](../../docs/assets/images/transmodel-cen/governance_fig.2_v20240906-1024x576.jpg)
...
![Figure 4: What are the different standards linked to Transmodel Parts.](../../docs/assets/images/transmodel-cen/Governance_fig.3_v20240906-1024x576.jpg)
...
![Figure 5: The different part of Transmodel and how they link to each other.](../../docs/assets/images/transmodel-cen/BubbleChartTransmodelUpdate0724-768x432.jpg)
...
CEN, Europe’s standardisation body, divides its work into committees covering different aspects of industry and technology, with a [well-defined process ](https://www.cen.eu/work/ENdev/how/Pages/default.aspx)and documentation formats.
...
The Transmodel standard (EN12896) is formally produced by [Technical Committee 278](http://www.itsstandards.eu/index.php?option=com_content&view=article&id=47&Itemid=27) (TC278), Working Group 3 (WG3), Sub Group 4 (SG4). Other TC278 WG3 sub groups handle the related standards:

  - [SIRI](https://transmodel-cen.eu/index.php/siri/): Service Interface for Real-time Information, CEN EN/TS 15531 1-7 (SG7)
  - [NeTEx](https://transmodel-cen.eu/index.php/netex/):* *Network, Timetables and Fare Exchange, CEN TS 16614-1 to 6 (SG9)
  - [OJP](https://transmodel-cen.eu/index.php/ojp/): Open API for Distributed Journey Planning, CEN TS 17118 (SG8)
  - [OpRa](https://transmodel-cen.eu/index.php/opra/): Operational Raw Data and Statistics, CEN TR 17370 (SG10). Under development is the corresponding TS.
