---
original_title: "Transmodel at a glance"
source: wordpress
source_url: https://transmodel-cen.eu/index.php/transmodel-at-a-glance/
slug: transmodel-at-a-glance
parent_id: 0
published: 2024-02-23 14:57:57
status: raw
---
...
It may be used for several [purposes](https://transmodel-cen.eu/index.php/purpose/), in particular to specify a data base or data exchange formats that enable the sharing and provision of accurate and interoperable public transport information across organisation- and system-boundaries. 
...
![Figure 1: Consistent travel information across different modes is essential](../../docs/assets/images/transmodel-cen/tag18-1-768x314-1.png)
...
![](../../docs/assets/images/transmodel-cen/tag02-1.png)
...
![](../../docs/assets/images/transmodel-cen/tag13-1.png)

*Figure 3: People and vehicles moving through a city*

![](../../docs/assets/images/transmodel-cen/tag19-1.png)

*Figure 4: A service journey with a bus going from B to F*

![](../../docs/assets/images/transmodel-cen/tag10-1.png)

*Figure 5: A service journey with a tram going from A to M*

![](../../docs/assets/images/transmodel-cen/tag12-1.png)
...
![](../../docs/assets/images/transmodel-cen/tag06-1.png)

*Figure 7: Trying to convey the concept of a person’s movement*

![](../../docs/assets/images/transmodel-cen/tag09-1.png)
...
![](../../docs/assets/images/transmodel-cen/tag08-1.png)    ![](../../docs/assets/images/transmodel-cen/tag17-1.png)
...
![Figure 10: Definition of Public Transport and modes covered by Transmodel](../../docs/assets/images/transmodel-cen/modes-of-operation-768x475.png)
...
![](../../docs/assets/images/transmodel-cen/tag16-1.png)
...
![](../../docs/assets/images/transmodel-cen/tag00-1.png)
...
![](../../docs/assets/images/transmodel-cen/tag05-1.png)
...
![](../../docs/assets/images/transmodel-cen/tag11-1.png)
...
![](../../docs/assets/images/transmodel-cen/tag01-1.png)
...
![](../../docs/assets/images/transmodel-cen/tag04-1.png)
...
![](../../docs/assets/images/transmodel-cen/tag03-1.png)
...
![](../../docs/assets/images/transmodel-cen/tag15-1.png)
